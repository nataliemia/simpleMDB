...
{ 
 ...
 { 
  ...
  { 
    ...
    { 
      new ActorMovie(1, 1, 1, "Vito Corleone", "Don of the Corleone family."), 
      new ActorMovie(2, 2, 1, "Michael Corleone", "Son who takes over the family."), 
      new ActorMovie(3, 3, 3, "Bruce Wayne", "The Dark Knight protecting Gotham."), 
      new ActorMovie(4, 4, 4, "Andy Dufresne", "Banker turned prisoner at Shawshank."), 
      new ActorMovie(5, 10, 10, "Dom Cobb", "A thief who enters dreams to steal secrets.") 
    }); 
  } 
